<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <!-- 클래스 객체 생성 차조변수에 대입하는 작업과 유사한 기능 -->
 <jsp:useBean id="student" class="sec01.StudentBean" scope="page" />
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
		<title>자바Bean관련 액션 태그</title>
	</head>
	<body>
		...
		<h3>빈 속성값 출력 (Setter 사용)</h3>
		<% student.setStdNo("20251122"); %>
		<% student.setStdName("박보검"); %>
		<% student.setStdPhone("010-1212-1212"); %>
		<% student.setStdAddress("서울시 서초구"); %>
		<% student.setStdYear(1); %>
