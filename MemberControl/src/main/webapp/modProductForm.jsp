...
<body>
 <h1 class="cls1">상품 정보 수정 창</h1>
<form method="post" action="${contextPath}/product/modProduct.do?prdNo=${prdInfo.prdNo}">
 <table align="center">
   <tr>
     <td width="200"><p align="right">상품 번호</td>
     <td width="400"><input type="text" name="prdNo" value="${prdInfo.prdNo}" disabled></td>
   </tr>
   <tr>
   ...
   <tr>
     ...
     <td width="400"><input type="number" name="ctgNo" value="${prdInfo.ctgNo}"></td>
   </tr>
   <tr align="center">
